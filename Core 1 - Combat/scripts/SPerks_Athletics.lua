...
-- list - meaning the framework held-perk cache (and therefore getARank())
-- is STALE and still reports the perk-being-removed as held at the moment
-- onRemove fires. AFTER _setPlayerPerks() runs, syncPerks() unconditionally
...
interfaces.ErnPerkFramework.registerPerk({
    ...
    art = "textures\\levelup\\knight",
    localizedFlavour = "You have learned the old traveller's art: shift the burden, trust the straps, and keep walking.",
...
interfaces.ErnPerkFramework.registerPerk({
    ...
    art = "textures\\levelup\\knight",
    localizedFlavour = "You know every cruel pound by feel, and you know how to make each one sit lighter than it should.",
...
interfaces.ErnPerkFramework.registerPerk({
    ...
    art = "textures\\levelup\\knight",
    localizedFlavour = "A light pack turns the whole world into open road, and your feet are eager to claim it.",
...
interfaces.ErnPerkFramework.registerPerk({
    ...
    art = "textures\\levelup\\knight",
    localizedFlavour = "Unburdened, you move like a thrown spear: over stone, through surf, and past anyone trying to keep pace.",
...
interfaces.ErnPerkFramework.registerPerk({
    ...
    art = "textures\\levelup\\knight",
    localizedFlavour = "Once you have your pace, the world seems to fall behind you one heartbeat at a time.",
...
interfaces.ErnPerkFramework.registerPerk({
    ...
    art = "textures\\levelup\\knight",
    localizedFlavour = "At the edge of collapse, when every muscle begs for mercy, something stubborn in you rises instead.",
