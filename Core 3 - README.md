...
- `luaconj debug` - reports recent summoning attempts, summons detected,
  bonuses applied, and the last empowered servant.
- `luarest debug` - reports the last Restoration cast, detected Restore effects,
  Spellforge recognition, and Ward of Delay collection state.
